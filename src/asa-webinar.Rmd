...
This presentation was last modified on `r date()`.
...
![](../images/my-logo-plus-mug-shot.png "P.Mean Consulting logo plus a picture of myself")
...
- you are part of a larger organization and
- you have a "boss".

You are an independent consulant if

- you work alone (or in a small group) and
...
If you're on your own, you miss out on a lot of support, such as a Human Resources department. You can't pop your head over the cubicle wall and ask a question. No one will decorate your cubicle with balloons on your birthday or bring in delicious food on pot luck Friday. 
...
You can start as a sole proprietorship and convert to an LLC or S/C corporation later. You can also convert an LLC to an S/C corporation. You should think about changing your business entity when your business grows (i.e., when you hire someone to work with you).
...
In a partnership, two or more people share ownership of a business. Partners are jointly and individually liable. You must define issues associated with dividing profits and the different responsibilities of each partner. You also need rules on how to add new partners and how to dissolve the partnership.

I do not recommend a business partnership. It would be simpler for you to set up your own business entity and then subcontract some of the work to your "partner".
...
An S corporation/C corporation has some protection against creditors and litigants. It has more stringent legal requirements than an LLC. Like an LLC, it requires paperwork and legal fees. It has special rules for taxation that can sometime save you money. Tax rules are the biggest differentiation between an LLC and an S/C corporation and also between an S corporation and a C corporation.

</div>

## Questions to ask about business entities

- <div class="red">Are you taking out a loan to start your independent consulting business?</div>
- How likely are you to be sued by your customers? 
...
- <div class="red">How likely are you to be sued by your customers?</div>
- How sensitive are you to tax issues?
- How complicated do you want your legal/accounting life to be? 

<div class="notes">

High litigation risk may make you seek out the protections of an LLC or S/C corporation.
...
You may not see substantial tax savings with different business models, but an S/C corporation offers ways to report income through different routes with different tax implications. The S/C corporation might also offer tax advantages to the payment of health benefits to yourself and your family.
...
If you bill by the project, get a scope of work in writing. If the scope of the project changes ("can I add one little thing?"), then change the fee.

Billing by the project gets your client to think in terms of how valuable the work is to them and (if you estimate your time well) will result in more income for you. Billing by the hour is faster and less risky.

</div>

## Accounting -- Invoicing

![](../images/sample-invoice.png "Image of a sample invoice for statistical consulting services")
...
You can dispense with a contract if you trust the other party to treat you fairly AND if you are willing to handle an unresolvable dispute by forgoing your consulting fee.
...
If someone demands that you use their contract, have it reviewed by a lawyer (at least for your very first contract).

"Unreasonable demands" could mean asking you to carry an excessive amount of insurance.
